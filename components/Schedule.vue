  ...
  <section class="Schedule">
    ...
    <ul>
      <li>
        <v-row>
          <v-col cols="12" md="3">
            <span class="Schedule-List-Title">エントリー募集期間</span>
          </v-col>
          <v-col cols="12" md="9">
      ...
      <li>
        <v-row>
          <v-col cols="12" md="3"
            ><span class="Schedule-List-Title">作品応募期間</span></v-col
          >
          <v-col cols="12" md="9"
            ><span class="Schedule-List-Content">9/30(水)まで</span></v-col
          >
        </v-row>
      </li>
      <li>
        <v-row>
          ...
          >
          <v-col cols="12" md="9">
            <span class="Schedule-List-Content"> 10月上旬 </span>
            <span class="Schedule-List-Content-Small">
      ...
      <li>
        <v-row>
          ...
          >
          <v-col cols="12" md="9">
            <span class="Schedule-List-Content"> 10月25日(日) </span>
            <span class="Schedule-List-Content-Small">
